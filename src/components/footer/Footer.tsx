            ...
            <div className="container mx-auto px-4 py-8 sm:py-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <div className="space-y-6">
                        <h3 className="text-lg sm:text-xl font-semibold text-secondary font-bold" style={{ WebkitTextStroke: '0.3px #000' }}>Contacto</h3>

                        {/* Sede Puente Alto */}
                        <div className="space-y-3">
                            <h4 className="font-medium text-secondary font-bold" style={{ WebkitTextStroke: '0.3px #000' }}>Sede {locations.puenteAlto.name}</h4>
                        ...
                        <div className="space-y-3">
                            <h4 className="font-medium text-secondary font-bold" style={{ WebkitTextStroke: '0.3px #000' }}>Sede {locations.santiagoCentro.name}</h4>
                            <p className="flex items-center gap-2 text-sm sm:text-base">
                                <FaPhone className="text-secondary" />
                                <Link
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg sm:text-xl font-semibold text-secondary font-bold" style={{ WebkitTextStroke: '0.3px #000' }}>Navegación</h3>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg sm:text-xl font-semibold text-secondary font-bold" style={{ WebkitTextStroke: '0.3px #000' }}>Síguenos</h3>
